...
function Header() {
  ...
  return (
      <div className='shadow-sm border-b bg-white sticky top-0 z-50'>
        <div onClick={() => router.push('/')} className='flex items-center justify-between max-w-6xl mx-5 lg:mx-auto'>
          ...
          <div className='max-w-xs flex items-center'>
            <div className='relative mt-1 p-3 rounded-md'>
              ...
              <input 
                ...
                transition ease-in-out delay-240' 
                type="text" 
                placeholder='Search'
              />
            </div>
          ...
          {session ? (
            <>
              ...
              <div className='navBtn relative'>
                ...
                text-xs w-5 h-5 bg-red-500 rounded-full flex items-center justify-center 
                text-white'>3</div>
              </div>
